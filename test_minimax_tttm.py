...
# mude cornelius pelo nome do seu modulo nos imports abaixo
import advsearch.cornelius.minimax as minimax          
import advsearch.cornelius.tttm_minimax as tttm_agent  
...
class TestAlphaBetaTTTM(unittest.TestCase):
    ...
    def test_utility(self):
        """
        Esse teste verifica a funcao utility em advsearch.cornelius.tttm_minimax
        """
